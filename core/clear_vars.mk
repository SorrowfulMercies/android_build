@@ -1,258 +1,16 @@
 -###########################################################		 +#
 -## Clear out values of all variables used by rule templates.		 +#CM-specific variable clears
 -###########################################################		 +#
 +LOCAL_IGNORE_SUBDIR :=
  		  
 -LOCAL_MODULE:=		 +LOCAL_MAVEN_GROUP :=
 -LOCAL_MODULE_PATH:=		 +LOCAL_MAVEN_ARTIFACT :=
 -LOCAL_MODULE_RELATIVE_PATH :=		 +LOCAL_MAVEN_VERSION :=
 -LOCAL_MODULE_STEM:=		 +LOCAL_MAVEN_CLASSIFIER :=
 -LOCAL_DONT_CHECK_MODULE:=		 +LOCAL_MAVEN_PACKAGING :=
 -LOCAL_CHECKED_MODULE:=		 +LOCAL_MAVEN_REPO :=
 -LOCAL_BUILT_MODULE:=		 +LOCAL_MAVEN_POM :=
 -LOCAL_BUILT_MODULE_STEM:=		 +LOCAL_MAVEN_TARGET_MODULE :=
 -OVERRIDE_BUILT_MODULE_PATH:=		 +LOCAL_MAVEN_REPO_ID :=
 -LOCAL_INSTALLED_MODULE:=		 +LOCAL_MAVEN_SOURCES :=
 -LOCAL_INSTALLED_MODULE_STEM:=		 +LOCAL_MAVEN_JAVADOC :=
 -LOCAL_PICKUP_FILES:=		
